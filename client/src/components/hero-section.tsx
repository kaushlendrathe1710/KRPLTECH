    ...
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-border bg-card/50 px-4 py-2 backdrop-blur-sm">
          ...
          <span className="text-sm font-medium">Software Development Company</span>
        </div>
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground md:text-xl">
          krpl.tech creates modern web and mobile applications with clean code and beautiful interfaces. 
          Explore our portfolio of projects built with expertise and innovation.
        </p>
